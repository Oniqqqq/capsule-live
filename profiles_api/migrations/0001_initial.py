# Generated by Django 3.0.6 on 2020-08-01 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_editor', models.ManyToManyField(blank=True, null=True, related_name='image_editor_user', to=settings.AUTH_USER_MODEL)),
                ...
                ('shared_to', models.ManyToManyField(blank=True, null=True, related_name='shared_to_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='CapsuleImage',
